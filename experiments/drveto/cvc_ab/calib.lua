...
local L = {t1=0,t2=0,v1=0,v2=0,tc1=0,tc2=0}     -- last-live latch
...
emu.addEventCallback(function()
  ...
  if prevMode == 4 and mode ~= 4 then
    deaths = deaths + 1
    logf(string.format("DEATH %03d frame=%d throat_p1=%d throat_p2=%d v1=%02X v2=%02X tc1=%d tc2=%d cap=%s",
      deaths, frame, L.t1, L.t2, L.v1, L.v2, L.tc1, L.tc2, capName))
    cap = -1
  end
  prevMode = mode
