...
function M.attach(cfg)
  ...
  emu.addMemoryCallback(function(addr, value) return (s.rcol + 1) % 8 end, emu.callbackType.read, w + 0x87)  -- W_TCOL: approach = target+1
  emu.addMemoryCallback(function(addr, value) return 4 end, emu.callbackType.read, w + 0x88)                     -- W_TROW: trigger board-row 4 (high)
