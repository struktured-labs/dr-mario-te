...
function M.attach(cfg)
  ...
  emu.addMemoryCallback(function(addr, value) return (s.rcol + 2) % 8 end, emu.callbackType.read, w + 0x87)  -- W_TCOL: approach = target+2
  emu.addMemoryCallback(function(addr, value) return 13 end, emu.callbackType.read, w + 0x88)                    -- W_TROW: trigger board-row 13 (LOW => short fall => would strand)
