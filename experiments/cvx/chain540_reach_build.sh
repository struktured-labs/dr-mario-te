#!/usr/bin/env bash
# CHAIN540 + DRREACH core: Childproof RTL 08f2343 + Childproof qsf.used + seed 13; firmware = CHAIN540 recipe + DRREACH=1
# (built in ~/projects/dr-mario-reach-wt, branch reach-root). Control hex for the FW-in-image proof = fw540 (6d13e6a1).
...
W=/home/struktured/projects/dr-mario-h16-wt/tmp/chain540_reach
FW=$W/fw540_reach.hex; WANT_FW=d8014d77a453780fc8f6d230c07cc617; CTRL=$W/fw540_ctrl.hex
CP_QSF=/home/struktured/projects/dr_mario_rl/tmp/rtl_chain/ship/theta400dblcanon-veto2fixa-seed13/NES.qsf.used
RTL=08f23434cac449db7ee5f641958fcc00c616c29d; TAG=childproof-chain540-reach
...
[ "$(md5sum "$FW" | cut -d' ' -f1)" = "$WANT_FW" ] || { echo "ABORT: fw540_reach md5"; exit 64; }
