...
PR._init(level,0,20,model_kind="bursty",bursty_model_obj=NutmegModel())
PR._C["trate"]=float(__import__("os").environ.get("TRATE","0.025"))
...
with open(out,"w") as fh:
    for i in range(cnt):
        ...
        fh.write(json.dumps({"v":variant,"seed":s,"cap":cap,"model":"nutmeg_v2_time_20260919","clear":int(r["won"]),"stall":int(r["stall"]),
