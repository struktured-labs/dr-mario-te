...
PR._PROBE=[]
w0,fl0=FX.variant("winner"); PR._C["w"],PR._C["fl"]=w0,fl0
for i in range(NGAMES): PR.play(38534+i*2)
plies=PR._PROBE
print(f"captured {len(plies)} real root boards over {NGAMES} champion games (L20 drip, cap 600)")
