#!/usr/bin/env bash
# Childproof core (RTL 08f2343, veto2fixa recipe, seed 13) with ONE firmware byte changed: DRCHAIN 180 -> 540.
...
W=/home/struktured/projects/dr-mario-h16-wt/tmp/chain540
FW=$W/fw540.hex; WANT_FW=6d13e6a1477af9c71ef7010a781ac091; CTRL=$W/fw180_rebuild.hex
CP_QSF=/home/struktured/projects/dr_mario_rl/tmp/rtl_chain/ship/theta400dblcanon-veto2fixa-seed13/NES.qsf.used
RTL=08f23434cac449db7ee5f641958fcc00c616c29d; TAG=childproof-chain540
...
[ "$(md5sum "$FW" | cut -d' ' -f1)" = "$WANT_FW" ] || { echo "ABORT: fw540 md5"; exit 64; }
...
"$QB/quartus_eda" --simulation=on --tool=modelsim --output_directory=output_files/simnet NES > "$OUT/eda.log" 2>&1; erc=$?
