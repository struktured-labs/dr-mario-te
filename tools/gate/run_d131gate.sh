#!/bin/bash
# run_d131gate.sh <orient 0..3> <frames> -- one constant-orient arm of the #132 mechanism probe.
...
orient="${1:?orient 0..3}"; maxf="${2:?frames}"; seed="${D1_SEED:-114}"
tag="dg_o${orient}_${maxf}_s${seed}_${D1_ARM:?D1_ARM required}"
...
out="$D/tmp/d131gate/$tag"; mkdir -p "$out"
