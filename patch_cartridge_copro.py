...
def build_main():
    ...
    a.label("act_p2_n")
    # steer-then-drop: gravity stays pinned until orient AND column are exact, then drop.
    # (fixes pills locking mid-rotation/mid-slide -> flipped or misplaced dual-color drops)
