    ...
    , TOP{this, namep}
{
    ...
    for (int __Vfinal = 0; __Vfinal < 2; ++__Vfinal) {
        __Vscope_CoproDrMario__leafeval.varInsert(__Vfinal,"base_holes", &(TOP.CoproDrMario__DOT__leafeval__DOT__base_holes), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RD,1 ,7,0);
        __Vscope_CoproDrMario__leafeval.varInsert(__Vfinal,"base_maxh", &(TOP.CoproDrMario__DOT__leafeval__DOT__base_maxh), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RD,1 ,4,0);
        ...
        __Vscope_CoproDrMario__leafeval.varInsert(__Vfinal,"colh", &(TOP.CoproDrMario__DOT__leafeval__DOT__colh), false, VLVT_UINT8,VLVD_NODIR|VLVF_PUB_RD,2 ,4,0 ,0,7);
        ...
        __Vscope_CoproDrMario__leafeval.varInsert(__Vfinal,"matched60", &(TOP.CoproDrMario__DOT__leafeval__DOT__matched60), false, VLVT_UINT16,VLVD_NODIR|VLVF_PUB_RD,1 ,12,0);
