...
- The loss autopsy (task #32) concluded the Stomper "never dies — it only loses
  footraces." That held for 400 AI-vs-AI losses across two levels. **lulu falsified the
...
- **"Beat lulu" is a better north star than any win rate vs our own bots.** She is the
